...
/**
 * @file
 * Definition of EntityScheduleMedicareMigration.
 */
class EntityScheduleMedicareMigration extends Migration {
  ...
  public function __construct($arguments) {
    ...
    $csv_file = DRUPAL_ROOT . '/' . 'sites/default/files/imports/Medicare_Schedule.csv';
    ...
    $this->addFieldMapping('field_department')->defaultValue('Medicare');
    ...
    // send these schedules to RAVdz, works the medicares.  Change the UID when needed!
    $this->addFieldMapping('uid')->defaultValue('339');
